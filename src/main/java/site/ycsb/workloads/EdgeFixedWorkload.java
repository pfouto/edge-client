 ...
 * </ul>
 */
public class EdgeFixedWorkload extends Workload {
  /**
   * The name of the database table to run queries against.
   */
  public static final String TABLENAMES_PROPERTY = "tables";
  ...
  public void init(Properties p) throws WorkloadException {
    r = new Random();
    tables = p.getProperty(TABLENAMES_PROPERTY).split(",");
    if(tables.length < 1){
    ...
    fieldlengthgenerator = EdgeFixedWorkload.getFieldLengthGenerator(p);
  ...
  String randomTable() {
    ...
    return tables[r.nextInt(tables.length)];
  }
  ...
  public void doTransactionRead(DB db) {
    ...
    String keyname = EdgeFixedWorkload.buildKeyName(keynum, zeropadding, orderedinserts);
