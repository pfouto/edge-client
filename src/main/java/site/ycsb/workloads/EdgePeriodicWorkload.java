 ...
 * </ul>
 */
public class EdgePeriodicWorkload extends Workload {
    /**
     * The name of the database table to run queries against.
     */
    public static final String TABLENAMES_LOCAL_PROPERTY = "local_tables";
    ...
    protected String[] localTables;
    protected String[] remoteTables;
    ...
    public void init(Properties p) throws WorkloadException {
        r = new Random();
        localTables = p.getProperty(TABLENAMES_LOCAL_PROPERTY).split(",");
        if (localTables.length < 1) {
            throw new WorkloadException("No local tables specified, check the " + TABLENAMES_LOCAL_PROPERTY + " property.");
        }
        remoteTables = p.getProperty(TABLENAMES_REMOTE_PROPERTY).split(",");
        if (remoteTables.length < 1) {
            throw new WorkloadException("No remote tables specified, check the " + TABLENAMES_REMOTE_PROPERTY + " property.");
        }
        ...
        fieldlengthgenerator = EdgePeriodicWorkload.getFieldLengthGenerator(p);
    ...
    public boolean doInsert(DB db, Object threadstate) {
        throw new UnsupportedOperationException("This workload does not support inserts");
    }
    ...
    String randomTable(String[] pool) {
        //returns a random element from the tables vector
    ...
    public void doTransactionReadModifyWrite(DB db) {
        throw new UnsupportedOperationException("ReadModifyWrite not implemented in EdgeFixedWorkload");
    }

    public void doTransactionScan(DB db) {
        throw new UnsupportedOperationException("Scan not implemented in EdgeFixedWorkload");
    }
    ...
    public void doTransactionInsert(DB db) {
        throw new UnsupportedOperationException("Insert not implemented in EdgeFixedWorkload");
    }
